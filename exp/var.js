...
let practice_prompt_stimuli = [
  {stimulus: practice_prompt_array[0], feedback: practice_feedback_array[0], outcome: practice_outcome_array[0], progress: progressBar, data: {block: 'practice', task_version: version, index: -1, probability: practiceProbability[0], handedness: handedness.toLowerCase(), easy_key: EasyKey_uCase.toLowerCase(), hard_key: HardKey_uCase.toLowerCase(), reward_easy: practiceEasy[0], reward_hard: practiceHard[0], hard_reward_magnitude: practiceHardRewardValue[0], /*eefrt_01_condition: trialCondition, trial_timeout: trialTimeout[0], */procedure: practiceOutcome[0]/*, eefrt_01_taps: tapTotal, trial_complete: trialComplete*/}},
  {stimulus: practice_prompt_array[1], feedback: practice_feedback_array[1], outcome: practice_outcome_array[1], progress: progressBar, data: {block: 'practice', task_version: version, index: -2, probability: practiceProbability[1], handedness: handedness.toLowerCase(), easy_key: EasyKey_uCase.toLowerCase(), hard_key: HardKey_uCase.toLowerCase(), reward_easy: practiceEasy[1], reward_hard: practiceHard[1], hard_reward_magnitude: practiceHardRewardValue[1], /*eefrt_01_condition: trialCondition, trial_timeout: trialTimeout[1], */procedure: practiceOutcome[1]/*, eefrt_01_taps: tapTotal, trial_complete: trialComplete*/}},
  {stimulus: practice_prompt_array[2], feedback: practice_feedback_array[2], outcome: practice_outcome_array[2], progress: progressBar, data: {block: 'practice', task_version: version, index: -3, probability: practiceProbability[2], handedness: handedness.toLowerCase(), easy_key: EasyKey_uCase.toLowerCase(), hard_key: HardKey_uCase.toLowerCase(), reward_easy: practiceEasy[2], reward_hard: practiceHard[2], hard_reward_magnitude: practiceHardRewardValue[2], /*eefrt_01_condition: trialCondition, trial_timeout: trialTimeout[2], */procedure: practiceOutcome[2]/*, eefrt_01_taps: tapTotal, trial_complete: trialComplete*/}},

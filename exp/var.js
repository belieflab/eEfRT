...
{stimulus: practice_prompt_array[0], feedback: practice_feedback_array[0], outcome: practice_outcome_array[0], progress: progressBar, data: {block: 'practice', task_version: version, trial: -1, probability: practiceProbability[0], handedness: handedness, easy_key: EasyKey_uCase, hard_key: HardKey_uCase, reward_easy: practiceEasy[practiceIterator], reward_hard: practiceHard[practiceIterator], procedure: practiceOutcome[0]}},
{stimulus: practice_prompt_array[1], feedback: practice_feedback_array[1], outcome: practice_outcome_array[1], progress: progressBar, data: {block: 'practice', task_version: version, trial: -2, probability: practiceProbability[1], handedness: handedness, easy_key: EasyKey_uCase, hard_key: HardKey_uCase, reward_easy: practiceEasy[practiceIterator], reward_hard: practiceHard[practiceIterator], procedure: practiceOutcome[1]}},
{stimulus: practice_prompt_array[2], feedback: practice_feedback_array[2], outcome: practice_outcome_array[2], progress: progressBar, data: {block: 'practice', task_version: version, trial: -3, probability: practiceProbability[2], handedness: handedness, easy_key: EasyKey_uCase, hard_key: HardKey_uCase, reward_easy: practiceEasy[practiceIterator], reward_hard: practiceHard[practiceIterator], procedure: practiceOutcome[2]}},
{stimulus: practice_prompt_array[3], feedback: practice_feedback_array[3], outcome: practice_outcome_array[3], progress: progressBar, data: {block: 'practice', task_version: version, trial: -4, probability: practiceProbability[3], handedness: handedness, easy_key: EasyKey_uCase, hard_key: HardKey_uCase, reward_easy: practiceEasy[practiceIterator], reward_hard: practiceHard[practiceIterator], procedure: practiceOutcome[3]}},
]

// experiment trials
let test_prompt_stimuli = [];
    for (let i = 0; i < test_feedback_array.length; i++){
    test_prompt_stimuli.push({stimulus: test_prompt_array[i], feedback: test_feedback_array[i], outcome: test_outcome_array[i], progress: progressBar, data: {block: 'experiment', task_version: version, trial: i+1, probability: experimentProbability[i], handedness: handedness, easy_key: EasyKey_uCase, hard_key: HardKey_uCase, reward_easy: easyAmount[experimentIterator], reward_hard: hardAmount[experimentIterator], procedure: experimentOutcome[i]}},)
    }

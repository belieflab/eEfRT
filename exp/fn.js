    ...
    function tick() {
        ...
        if (seconds > 0) {
            ...
            if (mins > 1) {
                ...
                //ends experiment when timer reaches 0
        ...
        if (seconds > 0) {
            ...
            if (mins > 1) {
                ...
                if (version === "money") {
                    ...
                    reward.push(
                        MinutesToPlay +
                            " Minute Timer! Experiment Complete.\nCongratulations! You won: " +
                            currency +
                            " " +
                            Math.round(rewardTally / 10) +
                            " " +
                            points +
                            "!\nPress OK to continue."
                    );
                    while (experimentIterator < experimentOutcome.length) {
                        // loops through to the end of all possible trials
                        jsPsych.endCurrentTimeline();
...
function versionRandomization() {
    if (version === "money") {
        ...
        hardAmount = [
            3.04, 1.42, 2.86, 3.22, 1.78, 1.96, 2.68, 1.78, 2.14, 2.5, 3.94,
            2.32, 2.14, 1.42, 3.04, 1.24, 3.58, 2.32, 4.12, 4.12, 2.5, 3.94,
            3.22, 4.12, 2.68, 3.4, 2.5, 3.76, 1.78, 1.42, 3.04, 3.4, 3.22, 1.24,
            3.58, 3.76, 3.76, 2.14, 3.58, 1.6, 2.86, 2.68, 1.24, 1.96, 1.6,
            2.86, 2.32, 3.4, 3.94, 1.96, 1.6, 2.59, 3.49, 3.85, 4.21, 4.03,
            3.67, 3.67, 4.03, 2.77, 1.51, 1.87, 4.21, 1.33, 1.87, 1.51, 3.13,
            3.13, 3.85, 2.59, 4.21, 2.95, 2.05, 2.77, 3.49, 1.87, 2.95, 3.13,
            3.67, 1.69, 2.59, 2.41, 1.33, 3.31, 2.23, 2.23, 4.03, 1.33, 2.41,
            3.31, 2.23, 3.85, 2.41, 3.31, 2.77, 2.05, 1.69, 3.49, 1.69, 2.95,
            2.05, 1.51,
        ];
        easyAmount = [
        ...
        experimentProbability = [
            12, 50, 50, 88, 12, 88, 50, 88, 50, 12, 50, 50, 12, 88, 88, 12, 88,
            12, 50, 12, 50, 12, 12, 88, 88, 50, 88, 50, 50, 12, 50, 88, 50, 88,
            12, 12, 88, 88, 50, 88, 12, 12, 50, 50, 12, 88, 88, 12, 88, 12, 50,
            12, 88, 50, 88, 12, 50, 12, 88, 50, 88, 88, 50, 50, 50, 50, 88, 12,
            12, 88, 12, 12, 88, 12, 50, 12, 50, 50, 88, 88, 50, 12, 88, 50, 12,
            50, 50, 12, 88, 12, 88, 88, 50, 88, 88, 12, 12, 12, 50, 88, 50, 12,
        ];
        hardRewardValue = [
            3, 1, 3, 3, 1, 2, 2, 1, 2, 2, 4, 2, 2, 1, 3, 1, 4, 2, 4, 4, 2, 4, 3,
            4, 2, 3, 2, 4, 1, 1, 3, 3, 3, 1, 4, 4, 4, 2, 4, 1, 3, 2, 1, 2, 1, 3,
            2, 3, 4, 2, 1, 2, 3, 4, 4, 4, 4, 4, 4, 3, 1, 1, 4, 1, 1, 1, 3, 3, 4,
            2, 4, 3, 2, 3, 3, 1, 3, 3, 4, 1, 2, 2, 1, 3, 2, 2, 4, 1, 2, 3, 2, 4,
            2, 3, 3, 2, 1, 3, 1, 3, 2, 1,
        ];
        ...
        instructions_9 = {
            ...
            stimulus:
                '<p style="color:white;"><b>We cannot pay you based on every choice you make.</b></p> ' +
        ...
        hardAmount = [
            304, 142, 286, 322, 178, 196, 268, 178, 214, 250, 394, 232, 214,
            142, 304, 124, 358, 232, 412, 412, 250, 394, 322, 412, 268, 340,
            250, 376, 178, 142, 304, 340, 322, 124, 358, 376, 376, 214, 358,
            160, 286, 268, 124, 196, 160, 286, 232, 340, 394, 196, 160, 259,
            349, 385, 421, 403, 367, 367, 403, 277, 151, 187, 421, 133, 187,
            151, 313, 313, 385, 259, 421, 295, 205, 277, 349, 187, 295, 313,
            367, 169, 259, 241, 133, 331, 223, 223, 403, 133, 241, 331, 223,
            385, 241, 331, 277, 205, 169, 349, 169, 295, 205, 151,
        ];
        easyAmount = [
    ...
    if (handedness === "RIGHT") {
        for (let i = 0; i <= 3; i++) {
            practice_prompt_array.push(
                "<br>" +
                    "<br>" +
                    '<p style="color:white;">Press the <strong>' +
                    HardKey_uCase +
                    "</strong> key. &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Press the <strong>" +
                    EasyKey_uCase +
                    "</strong> key.</p> " +
                    ...
                    "<br>" +
                    "<br>" +
                    '<p style="color:white;"> The probability of winning is ' +
                    practiceProbability[i] +
                    "%.   </p> "
            );
        }
